...
INSERT INTO images (id, link) VALUES (1, 'http://localhost:8081/uploads/cat-4.jpg');
INSERT INTO images (id, link) VALUES (2, 'http://localhost:8081/uploads/cat-5.jpg');
INSERT INTO images (id, link) VALUES (3, 'http://localhost:8081/uploads/cat-6.jpg');
INSERT INTO images (id, link) VALUES (4, 'http://localhost:8081/uploads/iphone.jpg');
INSERT INTO images (id, link) VALUES (5, 'http://localhost:8081/uploads/LAPTOP.jpg');
INSERT INTO images (id, link) VALUES (6, 'http://localhost:8081/uploads/TV.jpg');
INSERT INTO images (id, link) VALUES (7, 'http://localhost:8081/uploads/offer-2.png');

INSERT INTO products (id, best_seller, brand, category, color, compatibility, created_at, deleted, description, discount, features, material, model, name, new_arrival, on_sale, price, rating, size, stock_quantity, subcategory, updated_at, year, image_id, seller_id) VALUES (1, null, 'hp', 'Electronics', null, null, '2024-06-22 12:50:11.638129', null, 'great camera', null, null, null, null, 'camera', null, null, 333, null, null, 333, 'camera', '2024-06-22 12:50:11.638129', null, 1, 200);
...
INSERT INTO reviews (id, comment, created_at, rating, updated_at, buyer_id, product_id) VALUES (1, 'worst bag ever', '2024-06-22 13:12:10.781457', 3, '2024-06-22 13:12:10.781457', 300, 2);

INSERT INTO orders (id, billing_address, created_at, order_status, shipping_address, total_price, updated_at, buyer_id) VALUES (1, '{"name":"erick","address":"fairfield","city":"Fairfield","state":"IA","zip":"52557"}', '2024-06-22 13:19:22.512604', 'CANCELLED', '{"name":"erick","address":"fairfield","city":"Fairfield","state":"IA","zip":"52557"}', 320, '2024-06-22 13:20:35.348330', 300);
INSERT INTO order_items (id, created_at, price, quantity, updated_at, order_id, product_id) VALUES (1, '2024-06-22 13:19:22.528785', 320, 1, '2024-06-22 13:19:22.528785', 1, 2);
